...
public class CarBrakeFunction {
    ...
    { 
        ...
        while(table.hasNext())
        {
            ...
            unitId = "UNIT" + unitId;
            DataBaseInteraction.insertDocument(row, parameterTable);
        }
    }
    ...
    public void updateBrakeSpeeds(MongoCollection parameterTable)
    {
        ...
        while(table.hasNext())
        {
            ...
            try
            {
                brakeSpeed = CarBrakeFunctionCalculations.calculateBrakeSpeed(row.getDouble("deltaSpeed"), row.getDouble("deltaSecond"));
            }
            catch(Exception e)
            {
                brakeSpeed = 0.00;
            ...
            if(brakeSpeed < brakeSpeedBuffer)
            {
                ...
                DataBaseInteraction.insertDocument(document, parameterTable);
            }            
            lastRow = row;
        }
    }
